...
public class SpadeAlgorithm {
   ...
   public static int getAllCID() {
    ...
    public ArrayList getFreSeqList(double support, int length) {
        ...
        String filename = "src/dataset/dataset1.txt";
	 ...
	 for (int i=0;i<ItemList.size();i++){
        ...
        for (int i = 0; i < length; i++) {
            ...
            ///*
            if (i == 0 && false) {
                System.out.println("begin new sequence idlist-----------------------------------");
                System.out.println("Length= " + (i + 1) + "  Sequences idlist\n");
            ...
            for (int j = 0; j < f.size(); j++) {
                for (int k = j; k < f.size(); k++) {
                    if (k == j) {
                        ...
                        if (null != value) {
                            if (i == 1 && false) {
                                System.out.println("==========1" + value + "f1=" + f.get(j) + "f2=" + f.get(k) + "\n");
                            }
                            Tmp.add(value);
                        }
                    } else {
                        ...
                        if (null != value) {
                            if (i == 1 && false) {
                                System.out.println("==========2" + value + "f1=" + f.get(j) + "f2=" + f.get(k) + "\n");
                            }
                            Tmp.add(value);
                        }
                        ...
                        if (null != value) {
                            Tmp.add(value);
                            if (i == 1 && false) {
                                System.out.println("==========3" + value + "f1=" + f.get(j) + "f2=" + f.get(k) + "\n");
                            }
                        }
                        ...
                        if (null != value) {
                            Tmp.add(value);
                            if (i == 1 && false) {
                                System.out.println("==========4" + value + "f1=" + f.get(j) + "f2=" + f.get(k) + "\n");
                            }
                        }
                        ...
                        if (null != value) {
                            Tmp.add(value);
                            if (i == 1 && false) {
                                System.out.println("==========5" + value + "f1=" + f.get(j) + "f2=" + f.get(k) + "\n");
                            }
                        }
                        ...
                        if (null != value) {
                            Tmp.add(value);
                            if (i == 1 && false) {
                                System.out.println("==========6" + value + "f1=" + f.get(j) + "f2=" + f.get(k) + "\n");
                            }
                        }
                        ...
                        if (null != value) {
                            Tmp.add(value);
                            if (i == 1 && false) {
                                System.out.println("==========7" + value + "f1=" + f.get(j) + "f2=" + f.get(k) + "\n");
                            }
                        }
                    }
                }//end of for int k=j
            ...
            /*	
			System.out.println(" ----------------new Length= "+(i+2)+"  Sequences idlist\n");
            ...
            /*
			System.out.println(" ----------------sort  after= "+(i+2)+"  Sequences idlist\n");
			for(int t=0;t<Tmp.size();t++)
				System.out.println(Tmp.get(t));
             */
            FreSeqList.add(Tmp);
    ...
    public List<Integer> getFirstfrequentpatternsMovieID(ArrayList Freq) {
        ...
        List<IDList> tmp = (ArrayList) Freq.get(0);
            for (int i = 0; i < tmp.size(); i++) {
                value = (IDList) tmp.get(i);
                int movieID = Integer.parseInt(value.getSequence().replace("[", "").replace("]", "").replace(" ", ""));
